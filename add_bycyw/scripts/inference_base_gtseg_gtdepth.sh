...
# example usage:
# add_bycyw/scripts/inference_base_gtseg_gtdepth.sh 0 510 valid_unseen testrun mlm "aggregate_sum sem_search_all spatial_norm temperature_annealing new_obstacle_fn no_slice_replay" high
