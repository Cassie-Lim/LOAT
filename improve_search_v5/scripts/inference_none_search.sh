...
# 随机搜索
# example usage:
# CUDA_VISIBLE_DEVICES=1 improve_search_v5/scripts/inference_none_search.sh 0 200 valid_unseen prompter_none_search "aggregate_sum sem_search_all spatial_norm temperature_annealing new_obstacle_fn no_slice_replay" "lan_locs" high_low 0 26.0
