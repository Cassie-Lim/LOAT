...
# example usage:
# CUDA_VISIBLE_DEVICES=1 improve_search_v5/scripts/inference_seq_lan_gtseg.sh 0 200 tests_unseen seq "aggregate_sum sem_search_all spatial_norm temperature_annealing new_obstacle_fn no_slice_replay" "lan_locs" high_low 0 21.0
