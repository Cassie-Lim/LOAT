...
# CUDA_VISIBLE_DEVICES=3 trail/yolo_mask_rcnn_small/scripts/inference_id.sh 0 300 valid_unseen yolo512 mlm "aggregate_sum sem_search_all spatial_norm temperature_annealing new_obstacle_fn no_slice_replay" gt 2
...
--result_file trail/yolo_mask_rcnn_small/results_exp/ \
