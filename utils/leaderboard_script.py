...
seen_strs = ['unseen', 'seen']
for seen_str in seen_strs:
    # pickle_globs = glob("./results/leaderboard/actseqs_test_" +
    #                     seen_str + "_" + args.dn_startswith + "_" + "*")
    pickle_globs = glob(f"./improve_search_v5/results_cap/{args.dn_startswith}_replan_seqsearch_dropFailLoc/results/leaderboard/actseqs_tests_" +
                        seen_str + "_" + args.dn_startswith + "_" + "*")
    # pickle_globs = glob(f"./improve_search_v5/results_cap/{args.dn_startswith}_replan_low_seqsearch_dropFailLoc/results/leaderboard/actseqs_tests_" +
    #                     seen_str + "_" + args.dn_startswith + "_" + "*")
